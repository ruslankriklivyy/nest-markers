...
export class Init1698833649969 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "custom_field_types" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "name" character varying(80) NOT NULL, CONSTRAINT "PK_8647998e23fdfa8527e6456348a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "files" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "filename" character varying(80) NOT NULL, "url" character varying NOT NULL, "type" character varying NOT NULL, "size" double precision NOT NULL, "entity_id" integer, "entity_type" character varying, CONSTRAINT "PK_6c16b9093a142e0e7613b04a3d9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "custom_fields" ADD CONSTRAINT "FK_501e6ae781937c7e6f294c62e97" FOREIGN KEY ("custom_field_type_id") REFERENCES "custom_field_types"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
